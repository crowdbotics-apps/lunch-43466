"""
Django settings for lunch_43466 project.
...
WSGI_APPLICATION = 'lunch_43466.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lunch_43466 API",
    "DESCRIPTION": "API documentation for lunch_43466 App",
    "VERSION": "v1",
}
